...
LandingPage.getInitialProps = async () => {
  ...
  // const res = await axios.get("/api/users/currentuser"); // Important: This reques will run inside the nextjs client pod. And in that pod on 127.0.0.1:80/api/users/currentuser nothing is running. Hence error occured.
